                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              scrollCell(p.shortName ?? '-', scrollCols[1].$2),
                              scrollCell(p.distributionChannel ?? '-', scrollCols[2].$2),
                              scrollCell(p.specie ?? '-', scrollCols[3].$2),
                              scrollCell(p.weightPacking ?? '-', scrollCols[4].$2),
                              scrollCell(p.productWeight ?? '-', scrollCols[5].$2),
                              scrollCell(p.productPacking ?? '-', scrollCols[6].$2),
                              scrollCell(p.mrp != null ? '₹${p.mrp!.toStringAsFixed(0)}' : '-', scrollCols[7].$2, textColor: const Color(0xFF059669)),
                              scrollCell(p.gst != null ? '${p.gst!.toStringAsFixed(0)}%' : '-', scrollCols[8].$2),
                              scrollCell(p.hsnCode ?? '-', scrollCols[9].$2),
                              scrollCell(p.countryOfOrigin ?? '-', scrollCols[10].$2),
                              scrollCell(p.shelfLifeDays != null ? '${p.shelfLifeDays}' : '-', scrollCols[11].$2),
                              scrollCell(p.remarks ?? '-', scrollCols[12].$2),
                              scrollCell(p.yc70 != null ? '${p.yc70}' : '-', scrollCols[13].$2),
                              scrollCell(p.processingCharges != null ? '${p.processingCharges}' : '-', scrollCols[14].$2),
                              scrollCell(p.stock.toString(), scrollCols[15].$2, textColor: p.stock > 0 ? const Color(0xFF059669) : Colors.redAccent),
                            ],
                          ),
                        ),
                      )).toList(),
