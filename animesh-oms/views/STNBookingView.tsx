        ...
        <form onSubmit={handleSubmit} className="p-10 space-y-12">
          ...
          <div className="pt-10 border-t flex flex-col md:flex-row justify-between items-center gap-8">
             ...
             <button 
               ...
               className="w-full md:w-auto px-20 py-7 bg-indigo-600 text-white rounded-[32px] font-black text-sm uppercase tracking-[0.2em] shadow-xl hover:bg-indigo-700 transition-all active:scale-95 disabled:opacity-30 flex items-center justify-center gap-4"
             >
